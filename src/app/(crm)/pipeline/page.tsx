...
import { fmtR, isStale, diasAtras, ultimoContato, fmtFollowup, parseFollowup, leadData, leadHora, getLeadValor, getLeadValorAberto, getLeadValorFechado } from '@/lib/utils';
